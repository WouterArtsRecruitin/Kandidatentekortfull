# Canva Quick Templates Guide
**Nederlandse Vacature Optimizer - Marketing Materials in 15 Minuten**

## 🎨 Direct Te Maken Templates

### 1. LinkedIn Banner (5 minuten)
**Formaat: 1584 x 396 pixels**

**Quick Setup:**
1. Zoek "LinkedIn Banner" in Canva
2. **Achtergrond**: Gradient van #1E3A8A naar #FF6B35
3. **Tekst toevoegen**:
   - "Nederlandse Vacature Optimizer" (Poppins Bold, 48px, wit)
   - "AI-Powered Recruitment Excellence" (Inter Medium, 18px)
4. **Elements**: Zoek "briefcase icon" en "chart icon"
